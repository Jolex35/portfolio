...
const Projects = () => {
    ...
    return (
        <div>
            <section className="bg-[#1f1f1f] px-3 py-5 md:px-0 md:py-10 text-white text-center">
                <h2 className="mb-6 text-center text-2xl uppercase font-medium tracking-widest text-white">
                    Les compétences du BUT
                </h2>
                <ul>
                    {t("skills.skills", {returnObjects: true}).map((skill) => (
                        <li key={skill}>
                            <h2 className="py-1 text-center font-medium tracking-widest text-white">
                                {skill}
                            </h2>
                        </li>
                    ))}
            ...
            <section className="bg-green px-3 py-5 dark:bg-[#494949] md:px-0 md:py-10">
